...
class ClienteViewHolderAlterar(var binding: LayoutItemAgendaAlterarBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    fun bind(cliente: Cliente){
        ...
        binding.cardItemAlterar.setOnClickListener {
